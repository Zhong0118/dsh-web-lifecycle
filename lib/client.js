      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: styles_default.dialogActions, children: [
            ...
            confirm === "restart" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: styles_default.primary, onClick: () => void runRestart(), children: t("restart") }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: styles_default.danger, onClick: () => void runShutdown(), children: t("shutdown") })
          ] })
        ]
      }
    ) }) : null
